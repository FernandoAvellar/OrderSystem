package com.avellar.ordersystem.config;
...
import com.avellar.ordersystem.entities.Payment;
...
@Configuration
@Profile("test") // Mesmo nome definido na propertie spring.profiles.active
